...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	private RelativeLayout layout_viewager_content_rel;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		layout_viewager_content_rel = (RelativeLayout)view.findViewById(R.id.layout_viewager_content_rel);
	...
	public void setData(List<ImageView> views, List<ADInfo> list, ImageCycleViewListener listener, int showPosition) {
		...
		// viewPagerFragmentLayout.setLayoutParams(params); 
