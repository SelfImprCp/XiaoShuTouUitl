...
public class XRefreshListViewSize5Activity<T extends MyEntity> extends MyBaseActivity implements SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener, OnScrollListener {
    ...
    public void initView() {
        ...
        addFooterView();
         ...
         LogCp.i(LogCp.CP,XRefreshListViewSize5Activity.class + " 为空吗？" + mSwipeRefreshLayout);
        ...
        LogCp.i(LogCp.CP,XRefreshListViewSize5Activity.class + " 为空吗？ mErrorLayout" + mErrorLayout);
    ...
    class ParserTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                LogCp.i(LogCp.CP, XRefreshListViewSize5Activity.class + "解析 出来的数据 的，值 ，，"
                        + currentList);
